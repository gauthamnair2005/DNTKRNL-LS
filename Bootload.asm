; ====================================================================
; Donut Bootloader - A 16-bit bootloader for legacy computers and OSs
; Copyright (C) 2018-2023 Gautham Nair
;
; It scans the FAT12floppy for DNTKRNL.BIN, loads it and executes it.
...
OEMLabel		db "DONUTBOOT"	; Disk label
...
VolumeLabel		db "DONUT6     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "DNTKRNL  BIN"	; Donut6 kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "DNTKRNL.BIN not found!", 0
